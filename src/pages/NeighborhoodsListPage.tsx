      ...
      <section className="section bg-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Atuamos em Toda a Zona Sul de SP</h2>
          ...
          <div className="bg-brand-lightGray p-8 rounded-lg mb-12">
            <h3 className="text-2xl font-bold mb-6 text-center">Lista de Bairros Atendidos</h3>
            <NeighborhoodList />
          </div>
          
          <div className="mb-12">
            <h3 className="text-2xl font-bold mb-6">Desentupimento Rápido na Zona Sul de SP</h3>
          ...
          <div className="bg-brand-blue text-white p-8 rounded-lg text-center">
