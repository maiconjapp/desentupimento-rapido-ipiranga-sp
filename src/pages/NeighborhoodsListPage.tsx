      ...
      <section className="section">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-black">Atuamos em Toda a Zona Sul de SP</h2>
          ...
          <div className="bg-gray-800 p-8 rounded-lg mb-12">
            <h3 className="text-2xl font-bold mb-6 text-white">Lista de Bairros Atendidos</h3>
            <NeighborhoodList />
          </div>
          
          <div className="mb-12">
            <h3 className="text-2xl font-bold mb-6 text-black">Desentupimento Rápido na Zona Sul de SP</h3>
